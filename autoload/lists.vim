...
function! lists#init() abort " {{{1
  ...
  for [l:rhs, l:lhs] in items(extend({
        ...
        \ '<plug>(lists-moveup)': g:lists_maps_prefix . 'lk',
        \ '<plug>(lists-movedown)': g:lists_maps_prefix . 'lj',
        \ '<plug>(lists-uniq)': g:lists_maps_prefix . 'lu',
        \ '<plug>(lists-uniq-local)': g:lists_maps_prefix . 'lU',
        \ '<plug>(lists-show-item)': g:lists_maps_prefix . 'ls',
        \ '<plug>(lists-bullet-toggle-all)': g:lists_maps_prefix . 'lt',
        \ '<plug>(lists-bullet-toggle-local)': g:lists_maps_prefix . 'lT',
